  ...
  return (
    <main className="min-h-screen bg-[#f7f3ec] text-[#1c1c1c]">
      ...
      <section className="mx-auto max-w-7xl px-5 pb-8 pt-12 lg:px-8">
        ...
        <h1 className="mt-2 font-serif text-5xl text-[#0b3d2e]">Kami siap membantu.</h1>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {channels.map(({ icon: Icon, title, value, hint, href }) => (
            <a key={title} href={href} className="rounded-2xl bg-white p-5 shadow-[0_10px_30px_rgba(20,42,32,.05)] transition hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(20,42,32,.1)]">
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-5 pb-16 lg:grid-cols-[1.4fr_1fr] lg:px-8">
        <ContactForm />
