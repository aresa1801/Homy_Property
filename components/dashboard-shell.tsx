...
import { Bell, ChevronDown, ChevronRight, Home, LayoutDashboard, LogOut, Menu, Search, Settings, ShieldCheck, Sparkles, Users, X } from 'lucide-react'
...
const roleLinks: Record<Role, { label: string; href: string; icon: typeof LayoutDashboard }[]> = {
  ...
  Agent: [{ label: 'Overview', href: '/dashboard/agent', icon: LayoutDashboard }, { label: 'My Listings', href: '/dashboard/agent/manage#listings', icon: Home }, { label: 'Leads CRM', href: '/dashboard/agent/manage#crm', icon: Users }, { label: 'Analytics', href: '/dashboard/agent/manage#analytics', icon: Search }, { label: 'Billing', href: '/dashboard/agent/manage#billing', icon: Sparkles }],
  'Property Owner': [{ label: 'Overview', href: '/dashboard/property-owner', icon: LayoutDashboard }, { label: 'My Properties', href: '/dashboard/property-owner/manage#properties', icon: Home }, { label: 'Inquiries', href: '/dashboard/property-owner/manage#inquiries', icon: Users }, { label: 'Calendar', href: '/dashboard/property-owner/manage#calendar', icon: Search }, { label: 'List Property', href: '/list', icon: Sparkles }],
