...
import { BarChart3, Bell, Bot, CalendarDays, MessageSquare, ChevronDown, ChevronRight, Clock, FileSignature, Flag, Handshake, Home, LayoutDashboard, LogOut, Menu, Search, Settings, ShieldCheck, Sparkles, Users, WalletCards, X } from 'lucide-react'
...
import { PartnerSanctionBanner } from '@/components/partner-sanction-banner'
...
const roleLinks: Record<Role, { label: string; href: string; icon: typeof LayoutDashboard }[]> = {
  User: [{ label: 'Overview', href: '/dashboard/user', icon: LayoutDashboard }, { label: 'Favorites', href: '/dashboard/user/favorites', icon: Home }, { label: 'Inquiries & Chats', href: '/dashboard/user/inquiries', icon: Users }, { label: 'Visits', href: '/dashboard/user/visits', icon: CalendarDays }, { label: 'Konfirmasi Ketertarikan', href: '/dashboard/user/interest', icon: Handshake }, { label: 'AI Recommendations', href: '/dashboard/user/recommend', icon: Sparkles }, { label: 'Become an Agent / Owner', href: '/dashboard/user/apply', icon: Sparkles }],
  Agent: [{ label: 'Overview', href: '/dashboard/agent', icon: LayoutDashboard }, { label: 'Verifikasi Mitra', href: '/dashboard/agent/verification', icon: ShieldCheck }, { label: 'My Listings', href: '/dashboard/agent/listings', icon: Home }, { label: 'Leads CRM', href: '/dashboard/agent/leads', icon: Users }, { label: 'Konfirmasi Ketertarikan', href: '/dashboard/agent/interests', icon: Handshake }, { label: 'Analytics', href: '/dashboard/agent/analytics', icon: BarChart3 }, { label: 'Billing', href: '/dashboard/agent/billing', icon: WalletCards }, { label: 'Kalender & Ketersediaan', href: '/dashboard/agent/schedule', icon: CalendarDays }, { label: 'Rekam Percakapan', href: '/dashboard/agent/conversations', icon: MessageSquare }, { label: 'List Property', href: '/dashboard/agent/list', icon: Sparkles }, { label: 'Agreement', href: '/dashboard/agent/agreement', icon: FileSignature }, { label: 'AI Assistant', href: '/dashboard/agent/ai', icon: Sparkles }],
  'Property Owner': [{ label: 'Overview', href: '/dashboard/property-owner', icon: LayoutDashboard }, { label: 'Verifikasi Mitra', href: '/dashboard/property-owner/verification', icon: ShieldCheck }, { label: 'My Properties', href: '/dashboard/property-owner/properties', icon: Home }, { label: 'Inquiries', href: '/dashboard/property-owner/inquiries', icon: Users }, { label: 'Konfirmasi Ketertarikan', href: '/dashboard/property-owner/interests', icon: Handshake }, { label: 'Kalender & Ketersediaan', href: '/dashboard/property-owner/schedule', icon: CalendarDays }, { label: 'Rekam Percakapan', href: '/dashboard/property-owner/conversations', icon: MessageSquare }, { label: 'List Property', href: '/dashboard/property-owner/list', icon: Sparkles }, { label: 'Agreement', href: '/dashboard/property-owner/agreement', icon: FileSignature }, { label: 'AI Assistant', href: '/dashboard/property-owner/ai', icon: Sparkles }],
  Admin: [{ label: 'Overview', href: '/dashboard/admin', icon: LayoutDashboard }, { label: 'Verifikasi Mitra', href: '/dashboard/admin/verifications', icon: ShieldCheck }, { label: 'Moderate Listings', href: '/dashboard/admin/moderation', icon: ShieldCheck }, { label: 'Partnership', href: '/dashboard/admin/partnership', icon: Handshake }, { label: 'Users & Agents', href: '/dashboard/admin/users', icon: Users }, { label: 'Billing & Commission', href: '/dashboard/admin/billing', icon: WalletCards }, { label: 'Reports & Fraud', href: '/dashboard/admin/reports', icon: Flag }, { label: 'Sanksi & Teguran', href: '/dashboard/admin/sanctions', icon: ShieldCheck }, { label: 'AI Admin', href: '/dashboard/admin/ai-admin', icon: Bot }, { label: 'Konfirmasi Ketertarikan', href: '/dashboard/admin/interests', icon: Handshake }, { label: 'AI Monitoring', href: '/dashboard/admin/ai', icon: Bot }],
  'Super Admin': [{ label: 'Overview', href: '/dashboard/super-admin', icon: LayoutDashboard }, { label: 'Verifikasi Mitra', href: '/dashboard/super-admin/verifications', icon: ShieldCheck }, { label: 'Partnership', href: '/dashboard/super-admin/partnership', icon: Handshake }, { label: 'Roles & Permissions', href: '/dashboard/super-admin/roles', icon: ShieldCheck }, { label: 'Platform Billing', href: '/dashboard/super-admin/billing', icon: WalletCards }, { label: 'Sanksi & Teguran', href: '/dashboard/super-admin/sanctions', icon: ShieldCheck }, { label: 'AI Admin', href: '/dashboard/super-admin/ai-admin', icon: Bot }, { label: 'Audit Log', href: '/dashboard/super-admin/audit', icon: Flag }, { label: 'System Config', href: '/dashboard/super-admin/system', icon: Settings }, { label: 'Feature Flags', href: '/dashboard/super-admin/flags', icon: Sparkles }],
}
...
export function DashboardShell({ role, children, showSummary = true }: { role: Role; children: React.ReactNode; showSummary?: boolean }) {
  ...
  const translated = (label: string) => ({ Overview: 'Ringkasan', Favorites: 'Favorit', 'Inquiries & Chats': 'Pertanyaan & Pesan', Visits: 'Jadwal Kunjungan', 'Become an Agent / Owner': 'Daftar sebagai Agen atau Pemilik', Agent: 'Agen', 'Property Owner': 'Pemilik Properti', User: 'Pengguna', Settings: 'Pengaturan', 'List Property': 'Pasang Properti', Agreement: 'Perjanjian Kerjasama', 'My Listings': 'Listing Saya', 'Leads CRM': 'CRM Prospek', Analytics: 'Analitik', Billing: 'Penagihan', 'Billing & Commission': 'Penagihan & Komisi', 'Platform Billing': 'Penagihan Platform', 'My Properties': 'Properti Saya', Inquiries: 'Pertanyaan', Calendar: 'Kalender', 'Kalender & Ketersediaan': 'Kalender & Ketersediaan', 'Rekam Percakapan': 'Rekam Percakapan', 'Moderate Listings': 'Moderasi Listing', 'Users & Agents': 'Pengguna & Agen', 'Reports & Fraud': 'Laporan & Penipuan', 'AI Monitoring': 'Pemantauan AI', 'AI Assistant': 'Asisten AI', 'AI Recommendations': 'Rekomendasi AI', 'Konfirmasi Ketertarikan': 'Konfirmasi Ketertarikan', 'Roles & Permissions': 'Peran & Izin', 'System Config': 'Konfigurasi Sistem', 'Audit Log': 'Log Audit', 'Feature Flags': 'Feature Flag', 'Super Admin': 'Super Admin', Admin: 'Admin', 'Verifikasi Mitra': 'Verifikasi Mitra' }[label] ?? label)
