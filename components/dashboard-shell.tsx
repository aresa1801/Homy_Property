...
import { BarChart3, Bell, Bot, CalendarDays, ChevronDown, ChevronRight, FileSignature, Flag, Home, LayoutDashboard, LogOut, Menu, Search, Settings, ShieldCheck, Sparkles, Users, WalletCards, X } from 'lucide-react'
...
const roleLinks: Record<Role, { label: string; href: string; icon: typeof LayoutDashboard }[]> = {
  ...
  'Super Admin': [{ label: 'Overview', href: '/dashboard/super-admin', icon: LayoutDashboard }, { label: 'Roles & Permissions', href: '/dashboard/super-admin/roles', icon: ShieldCheck }, { label: 'Platform Billing', href: '/dashboard/super-admin/billing', icon: WalletCards }, { label: 'Audit Log', href: '/dashboard/super-admin/audit', icon: Flag }, { label: 'System Config', href: '/dashboard/super-admin/system', icon: Settings }, { label: 'Feature Flags', href: '/dashboard/super-admin/flags', icon: Sparkles }],
}
