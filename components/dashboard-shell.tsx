...
export function DashboardShell({ role, children, showSummary = true }: { role: Role; children: React.ReactNode; showSummary?: boolean }) {
  ...
  const navItemClass = (active: boolean) => 'group flex shrink-0 items-center gap-3 rounded-xl px-4 py-2.5 text-sm transition ' + (active ? 'bg-[#c9a961] font-semibold text-[#0b3d2e] shadow-[0_8px_20px_rgba(201,169,97,.22)]' : 'text-white/70 hover:bg-white/10 hover:text-white')
